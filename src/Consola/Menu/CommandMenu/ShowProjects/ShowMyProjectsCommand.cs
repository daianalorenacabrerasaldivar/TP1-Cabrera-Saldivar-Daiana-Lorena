...
{
    public class ShowMyProjectsCommand : IMenuOptionCommand
    {
        public string Name => "Ver mis proyectos";
        ...
        public async Task ExecuteAsync()
        {
            try
            {
                _userInteractionService.ShowMessage("Ver mis proyectos");
                ...
                {
                    _userInteractionService.ShowMessage("No tienes proyectos creados.");
                    return;
                }
