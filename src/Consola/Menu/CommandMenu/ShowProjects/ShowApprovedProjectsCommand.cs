...
{
    public class ShowApprovedProjectsCommand : IMenuOptionCommand
    {
        public string Name => "Ver proyectos Aprobados";
        ...
        public ShowApprovedProjectsCommand(
        ...
        public async Task ExecuteAsync()
        {
            try
            {
                _userInteractionService.ShowMessage("Ver proyectos Aprobados");
                ...
                {
                    Status = new List<int> { (int)StatusEnum.Approved },
                ...
                {
                    _userInteractionService.ShowMessage("No tienes proyectos que haya Aprobado.");
                    return;
                }
